...
public class LevelRenderer {
    ...
    public LevelRenderer(LevelData currentLevelData) {
    ...
    public void updateTileOccupation() {
        for (Actor actor : currentLevelData.getActors()) {
        ...
        for (Collectible collectible : currentLevelData.getCollectibles()) {
    ...
    private <T> void renderNodes(Pane pane, List<T> nodes) {
        pane.getChildren().clear(); // Clear previous nodes
